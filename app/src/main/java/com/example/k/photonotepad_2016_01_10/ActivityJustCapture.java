...
public class ActivityJustCapture extends Activity {
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            // TODO передать имя файла в Activity_Note
...
// // TODO: исправить путь к папке на  Activity_Note.programDirectoryName + File.separator + NotesListActivity.notepadName + File.separator + NotesListActivity.noteIndex
        File path = new File(Environment.getExternalStorageDirectory(), "исправить");
        if (!path.exists()) {
            if (!path.mkdirs()) {
                return null;
            }
